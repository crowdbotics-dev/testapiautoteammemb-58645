...
## Project Structure
    ...
    ├── testapiautoteammemb_58645  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_58645`
...
2. Clone this repo and `cd testapiautoteammemb_58645`
